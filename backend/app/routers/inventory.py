    ...
    for inv in results:
        response.append({
            "pioneer": {
                ...
                "discord_id": inv.user.discord_id,
                "avatar": inv.user.avatar,
                "role": inv.user.role,
                "is_pioneer": inv.user.is_pioneer,
                "is_treasurer": inv.user.is_treasurer,
                "aliases": inv.user.aliases,
    ...
    for pioneer in pioneers:
        ...
        pioneer_stats.append({
            "pioneer": {
                ...
                "discord_id": pioneer.discord_id,
                "avatar": pioneer.avatar,
                "role": pioneer.role,
                "is_pioneer": pioneer.is_pioneer,
                "is_treasurer": pioneer.is_treasurer,
                "aliases": pioneer.aliases,
